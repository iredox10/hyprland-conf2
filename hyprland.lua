...
hl.on("hyprland.start", function()
	...
	hl.dsp.exec_cmd("udiskie --automount --notify --tray")
end)
...
-- Actions
hl.bind(mainMod .. " + W", hl.dsp.exec_cmd("ghostty"))
...
hl.bind(
	"SHIFT + Print",
	hl.dsp.exec_cmd([[grim -g "$(slurp)" - | tee ~/Pictures/screenshot-$(date +%s).png | wl-copy -t image/png]])
)
hl.bind(
	"ALT + Print",
	hl.dsp.exec_cmd(
		[[grim -g "$(hyprctl clients -j | jq -r '.[] | select(.focused == true) | \"\(.at[0]),\(.at[1]) \(.size[0])x\(.size[1])\"')" - | tee ~/Pictures/screenshot-$(date +%s).png | wl-copy -t image/png]]
	)
)
hl.bind(
	mainMod .. " + G",
	hl.dsp.exec_cmd([[grim - | tee ~/Pictures/screenshot-$(date +%s).png | wl-copy -t image/png]])
)
hl.bind(
	mainMod .. " + T",
	hl.dsp.exec_cmd([[grim -g "$(slurp)" - | tee ~/Pictures/screenshot-$(date +%s).png | wl-copy -t image/png]])
